...
| 23 | 2026-08-11 | Codex | AMEND — 2 P1: a gutted fixture corpus stayed green (no completeness gate); three more normative copies of the promotion rule; 1 P2: inflated fixture count | `04c54ef` (PR #6 head) |
| 23-fix | 2026-08-11 | Claude (author) | closure of round 23: coordinates derived from receipt bytes and matched against the exact Cartesian product, with duplicate and metadata-drift guards; rule copies removed in favour of the matrix; count corrected to 46 | `04c54ef` → `author/signatures` |
| 24 | 2026-08-11 | Codex | AMEND — 1 P1: the conformance corpus itself was read fail-open (no family tag check, permissive JSON and base64); 1 P2: deleting metadata was cheaper than lying in it | `e0fb16e` (PR #6 head) |
